...
|---|---|---|---|
| B1 | Undo lần 2 không restore group state | 🔴 Cao | Gate 1 — G1.T1 (bIsRestoring) |
...
### Trạng thái
- **Chưa fix.** Scheduled: Gate 1 G1.T1 (trước Sprint D)
- Đọc `00_Core/02_Current_Sprint.md` mục G1.T1 khi bắt đầu
