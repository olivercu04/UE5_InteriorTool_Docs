...
**Phiên bản:** 13/07/2026 — C5.8 Task Card #2 (2d rename host) + Wire Move + Wire Save ✅ build + test node-level DONE, REG C5.8 (regression cuối) CHƯA chạy | WBP_FurnitureInventory v3.11
