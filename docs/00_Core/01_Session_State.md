...
**Phiên bản:** 06/07/2026 — 21:15 ICT — NF.G3 (nút "+") ✅ + C5.6 (Xóa folder) ✅ + C5.7a (ChipTag right-click) ✅ DONE, C5.7b (inline rename chip) 🔲 CÒN NỢ | WBP_FurnitureInventory v3.7
...
6. 🔄 **ChipTag right-click + rename (C5.7)** — C5.7a DONE (06/07, right-click + context menu, tái dùng `OnComboTreeNodeRightClicked`). C5.7b (inline rename trong chip, nhúng `WBP_EditableLabel`) CÒN NỢ — kế tiếp.
