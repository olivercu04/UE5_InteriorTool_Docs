...
**Phiên bản:** 06/07/2026 — 23:40 ICT — C5.7b ✅ DONE + 2 bug fix (CreateNewFolder/RenameFolder) — **C5 HOÀN TẤT** | WBP_FurnitureInventory v3.8
...
→ **REG (regression 12 bước)** → C5 chốt sổ hoàn toàn → C6/C7 (defer) hoặc WBP_Toast → C9.
