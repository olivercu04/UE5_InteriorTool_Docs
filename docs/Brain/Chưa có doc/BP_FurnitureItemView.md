...
**← Được gọi bởi**
- [[WBP_FurnitureInventory]] — tạo 1 ô cho mỗi hàng lọc · Make BP_FurnitureItemView
- [[WBP_FurnitureCard]] — đọc mã đồ từ ô · Cast BP_FurnitureItemView → RowName
