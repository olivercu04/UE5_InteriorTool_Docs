# WBP_MeshControls
**Phiên bản:** 1.1 | **Cập nhật:** 25/05/2026 — 17:29 ICT | Persistent Toolbar — luôn hiển thị trên màn hình
...
Branch ActiveModeButton == BTN_Move? (toggle off)
  ...
  False:
    ...
    Cast TransformerPawnRef → ActivateGizmo(SelectedFurnitureActor, TransformerPawn, Translation)
```
...
Branch ActiveModeButton == BTN_Rotate? (toggle off)
  ...
  False:
    ...
    Cast TransformerPawnRef → ActivateGizmo(SelectedFurnitureActor, TransformerPawn, Rotation)
```
...
Branch ActiveModeButton == BTN_Scale? (toggle off)
  ...
  False:
    ...
    DeactivateGizmo  ← PHẢI trước ActivateGizmo
    Cast TransformerPawnRef → ActivateGizmo(SelectedFurnitureActor, TransformerPawn, Scale)
```
